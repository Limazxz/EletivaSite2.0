          ...
          <div className="hero-content">
            <div className="hero-text">
              ...
              <p className="hero-description animate-fade-in-delay">
                🔍 Nossa missão é despertar nos estudantes uma nova perspectiva
                sobre o turismo, apresentando-o como uma potente ferramenta de
                desenvolvimento econômico, social e cultural.
              </p>
              <p className="hero-description animate-fade-in-delay">
                A eletiva busca capacitar os alunos com conhecimentos práticos e
                teóricos sobre o turismo corporativo, empreendedorismo no setor
                e as diversas oportunidades de negócio que o envolvem.
              </p>
            </div>
